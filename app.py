...
초등학교 = ["배봉초", "전농초", "전동초", "휘봉초", "삼육초", "청량초"]
중학교 = ["휘경여중", "전동중", "전일중", "전농중", "동대문중", "장평중", "경희중", "경희여중"]
고등학교 = ["휘경여고", "해성여고", "동대부고", "휘봉고", "경희고", "경희여고", "대광고", "한대부고", "혜원여고", "중화고", "석관고"]
학년_초 = ["초3", "초4", "초5", "초6"]
학년_중 = ["중1", "중2", "중3"]
학년_고 = ["고1", "고2", "고3"]
...
과목_초 = ["초3-1", "초3-2", "초4-1", "초4-2", "초5-1", "초5-2", "초6-1", "초6-2"]
과목_중 = ["중1-1", "중1-2", "중2-1", "중2-2", "중3-1", "중3-2"]
과목_고 = ["공통수학1", "공통수학2", "대수", "미적분1", "미적분2", "확률과 통계", "기하", "수학1", "수학2", "미적분"]
...
# 원생입력 화면
    ...
    with col1:
        ...
        homeroom = st.session_state.user  # 자동입력
        if st.button("저장"):
